...
# ===================== RUL 参数 =====================
RUL_START_INDEX = 5000        # ✅ 尚未失效的预测起点（改大一点 否则看不到失效 也不能太大 否则会一致失效）
INIT_WINDOW = 200

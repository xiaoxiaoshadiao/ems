...
def main():
    ...
    ax.set_title('215通道电压预测结果（最优 RMSE）',
    ...
    if SAVE_FIG:
        plt.savefig(f"{SAVE_DIR}/215通道_few_shot_10步.png", dpi=500)
